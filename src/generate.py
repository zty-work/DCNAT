...
def _main(cfg: DictConfig, output_file):
    ...
    for sample in progress:
        ...
        if cfg.generation.decoding_mode == 1 or cfg.generation.decoding_mode ==2:
            sample['sample_constraints']=[[[task.tgt_dict.indices[_] for _ in tp.split(" ")] for tp in sample_constraints[index]] for index in id]
        else:
